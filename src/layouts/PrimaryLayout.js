...
class PrimaryLayout extends PureComponent {
  ...
  render() {
    ...
    const { user, theme, routeList, collapsed, permissions, notifications } = app
    const { isMobile } = this.state
    ...
    return (
      <Fragment>
        <Layout>
          ...
          <div className={styles.container} style={{ paddingTop: config.fixedHeader ? 64 : 0 }} id="primaryLayout">
            <Header {...headerProps} />
